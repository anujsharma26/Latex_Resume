...
\mobile{+91- 6378432276}

\email{anujsharmah001@gmail.com}
%\homepage{www.posquit0.com}
\github{anujsharma26}
\linkedin{xanujsharma}
%\skype{skypeid}
...
\position{Computer Science Engineer} % Your expertise/fields


\makecvfooter{}{This Resume was designed using Latex and the source code is available for download at www.github.com/xanujsharma/ss .}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
